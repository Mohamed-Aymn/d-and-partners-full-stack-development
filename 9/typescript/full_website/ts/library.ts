...
function getRows(): NodeListOf<HTMLElement> | [] {
  if (!list) return [];
  return list.querySelectorAll<HTMLElement>('.book-row');
}
...
for (let i = 0; i < chips.length; i++) {
  chips[i].addEventListener('click', function (this: HTMLElement) {
